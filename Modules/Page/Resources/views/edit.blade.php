                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-control-line m-t-40" action="{{route('page.update',$page->id)}}" method="post">
                                @method('put')
                            ...
                            @endif
                                    ...
                                    <div class="form-group form-md-line-input col-6">
                                        ...
                                        <input type="checkbox" class="switch" {{$page->status==1 ? 'checked' : ''}} data-on-color="primary" data-off-color="info" name="status">
