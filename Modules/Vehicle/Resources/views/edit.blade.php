...
<div class="form-group form-md-line-input col-6">
    ...
    <select class="form-control" name="name">
        ...
        <option value="{{$name->id}}" {{$name->id==$vehicle->name ? 'selected' : ''}}>{{$name->name}}</option>
        @endforeach
    </select>
    @if($errors->has('name'))
...
<div class="form-group form-md-line-input col-6">
    ...
    <select class="form-control" name="make" onchange="getModal(this)">
        ...
        <option value="{{$make->id}}" {{$make->id==$vehicle->make ? 'selected' : ''}}>{{$make->name}}</option>
        @endforeach
...
<div class="form-group form-md-line-input col-6">
    ...
    <input type="text" name="grade" value="{{$vehicle->grade}}"
        class="form-control">
    @if($errors->has('grade'))
...
<div class="form-group form-md-line-input col-6">
    ...
    <select class="form-control" name="fuel_type">
        ...
        <option value="{{$fuel->id}}" {{$vehicle->fuel_type== $fuel->id ? 'selected' : ''}}>{{$fuel->name}}</option>
        @endforeach
    </select> 
...
<div class="form-group form-md-line-input col-6">
    ...
    <select class="form-control" name="engine">
        ...
        <option value="{{$eng->id}}" {{$vehicle->engine== $eng->id ? 'selected' : ''}}>{{$eng->name}}</option>
        @endforeach
    </select>
...
<div class="form-group form-md-line-input col-6">
    ...
    <select class="form-control" name="transmission">
        ...
        <option value="{{$trans->id}}" {{$vehicle->transmission == $trans->id ? 'selected' : ''}}>{{$trans->name}}</option>
        @endforeach
    </select>
...
<div class="form-group form-md-line-input col-6">
    ...
    <select class="form-control" name="exterior_color">
        ...
        <option value="{{$ext->id}}" {{$vehicle->exterior_color == $ext->id ? 'selected' : ''}}>{{$ext->name}}</option>
        @endforeach
    </select>
...
<div class="form-group form-md-line-input col-6">
    ...
    <select class="form-control" name="interior_color">
        ...
        <option value="{{$int->id}}" {{$vehicle->interior_color == $int->id ? 'selected' : ''}}>{{$int->name}}</option>
        @endforeach
    </select>
...
<div class="form-group form-md-line-input col-6">
    ...
    <input type="text" name="wheel_style" value="{{$vehicle->wheel_style}}"
        class="form-control">
...
<div class="form-group form-md-line-input col-6">
    ...
    <input type="text" name="chassis_no" value="{{$vehicle->chassis_no}}"
        class="form-control">
...
<div class="form-group form-md-line-input col-6">
    ...
    <select class="form-control" name="interior_type">
        ...
        <option value="{{$intty->id}}" {{$vehicle->interior_type == $intty->id ? 'selected' : ''}}>{{$intty->name}}</option>
        @endforeach
    </select>
...
<div class="form-group form-md-line-input col-6">
    ...
    <input type="text" name="kilometers" value="{{$vehicle->kilometers}}"
        class="form-control">
...
<div class="form-group form-md-line-input col-6">
    ...
    <input type="text" name="drive" value="{{$vehicle->drive}}"
        class="form-control">
    @if($errors->has('drive'))
...
<div class="form-group form-md-line-input col-6">
        ...
        <input type="checkbox" class="switch" data-on-color="primary" data-off-color="info" name="status" {{$vehicle->status == 1 ? 'checked' : ''}}>
                            ...
                            <div class="form-group form-md-line-input col-12">
                                    ...
                                    <input type="file" id="image" name="image" class="dropify" data-default-file="{{asset('/storage/uploads/'.$vehicle->image)}}" />
...
$vehicle->accessories = !empty($vehicle->accessories) ? json_decode($vehicle->accessories,true) : [];
@endphp
@foreach($accessories as $k=>$acc)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="{{$acc}}" id="{{$k}}" name="accessories[]" {{in_array($acc,$vehicle->accessories) ? 'checked' : ''}}>
                            ...
                            <div class="form-group form-md-line-input col-6">
                                        ...
                                        @if($vehicle->gallary)
                                        @foreach($vehicle->gallary as $gallry)

                                        <img src="{{asset('storage/uploads/'.$gallry->name)}}" width="100px">
                                        @endforeach
                                        @endif
                                    </div>
                                    <div class="form-group form-md-line-input col-6">
                                        <label class="form-label">Comment</label>
                                        <textarea name="comments" class="form-control">{{$vehicle->comments}}</textarea>
                                    </div>
                            </div>
            ...
            <!-- ============================================================== -->
                            ...
                            var e = document.querySelector(`[name="make"]`);
