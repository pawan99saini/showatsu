...
<div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Make</h4>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-control-line m-t-40" action="{{route('make.update',$make->id)}}" method="post">
                                @method('put')
                            ...
                            @endif
                                    ...
                                    <div class="form-group form-md-line-input col-6">
                                        ...
                                        <input type="checkbox" class="switch" {{$make->status==1 ? 'checked' : ''}} data-on-color="primary" data-off-color="info" name="status">
