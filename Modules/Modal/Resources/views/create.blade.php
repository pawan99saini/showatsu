                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-control-line m-t-40" action="{{route('modal.store')}}" method="post">
                                @csrf    
                                <div class="row">
                                    <div class="form-group form-md-line-input col-6">
                                        <label class="form-control-label" for="make_id">Make</label>
                                ...
                                <div class="error text-danger fs-5">{{ $errors->first('make_id') }}</div>
                            @endif
                                    </div>
