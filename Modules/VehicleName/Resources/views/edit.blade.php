                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-control-line m-t-40" action="{{route('vehicle-name.update',$vehiclename->id)}}" method="post">
                                @method('put')
                                ...
                                <div class="row">
                                    <div class="form-group form-md-line-input col-6">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" value="{{$vehiclename->name}}">
                                        @if($errors->has('name'))
                            ...
                            @endif
                                    ...
                                    <div class="form-group form-md-line-input col-6">
                                        ...
                                        <input type="checkbox" class="switch" {{$vehiclename->status==1 ? 'checked' : ''}} data-on-color="primary" data-off-color="info" name="status">
